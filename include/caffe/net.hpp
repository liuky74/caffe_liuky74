 ...
 */
    ...
    public:
        ...
        explicit Net(const string &param_file, /*配置文件路径*/
                     Phase phase,/*模型的执行模式, train or test*/
                     /* level和stages两个参数都是为了增加prototxt文件灵活性而设置的,
                      * 可以通过在prototxt中对某一层设定不同的level或者stage来使其不参与某些等级或阶段的运行
                      * 详情见 https://zhuanlan.zhihu.com/p/55606429
                      * */
                     const int level = 0,/*运算等级,符合当前等级的layer会参与运算*/
                     const vector <string> *stages = NULL,/*运算阶段,符合当前阶段的layer会参与运算*/
